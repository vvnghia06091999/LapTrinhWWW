...
public class DangNhapController {
	...
	public String DangNhap(@Valid @ModelAttribute("taiKhoan") TaiKhoan taiKhoan, BindingResult theBindingResult,
		...
		if (theBindingResult.hasErrors()) {
			...
			if (check == false && !taiKhoan.getTenTaiKhoan().equalsIgnoreCase("admin")
