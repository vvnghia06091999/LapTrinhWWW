...
public class DangKiController {
	...
	public String formdangki(HttpServletRequest request, HttpServletResponse response)
	...
	public String showThongTinCaNhan(Model model, HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	public String updateTTKH(@Valid @ModelAttribute("kH") KhachHang khachHang, BindingResult theBindingResult,
			@RequestParam("tenTaiKhoan") String tenTaiKhoan, HttpServletRequest request, HttpServletResponse response)
