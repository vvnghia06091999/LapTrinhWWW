...
import vn.edu.iuh.daos.KhachHangDAO;
...
public class KhachHangDAOImpl implements KhachHangDAO {
	...
	public List<KhachHang> getAllKhachHang() {
		// TODO Auto-generated method stub
		Session session = this.sessionFactory.getCurrentSession();
		List<KhachHang> khachHangs = session.createNativeQuery("select *from KhachHang", KhachHang.class)
				.getResultList();
		return khachHangs;
	}
	...
	public KhachHang getKhachHangByTaiKhoan(String tenTaiKhoan) {
		...
		list = session.createNativeQuery("select *from dbo.KhachHang where TENTAIKHOAN = '" + tenTaiKhoan + "'",
