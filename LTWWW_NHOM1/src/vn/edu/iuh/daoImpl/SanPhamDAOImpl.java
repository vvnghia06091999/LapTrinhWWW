...
import vn.edu.iuh.daos.SanPhamDAO;
...
public class SanPhamDAOImpl implements SanPhamDAO {
	...
	public List<SanPham> getSanPhamByDanhMucByTen(String tenDanhMuc) {
		...
		return session.createNativeQuery(
				"select * from [dbo].[SanPham] sp join [dbo].[DanhMuc] dm on sp.MADANHMUC=dm.MADANHMUC where dm.[TENDANHMUC]=N'"
						+ tenDanhMuc + "'",
	...
	public List<SanPham> getAllSanPhambyTrangThai() {
		...
		List<SanPham> sanPhams = session
				.createNativeQuery("select * from SanPham s where s.trangThai='true'", SanPham.class).getResultList();
		return sanPhams;
	}
