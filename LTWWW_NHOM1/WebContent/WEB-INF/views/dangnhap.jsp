...
<link href="<c:url value="css/csslogin.css"/>" rel='stylesheet'
	type='text/css' />
		...
		<div class="row vertical-center-row">
			<div class="col-md-4 col-center-block login-widget">
				...
				<div>
					...
					<form:form action="xulydangnhap" method="POST"
						...
						<div class="form-group">
							<div class="input-group">
								...
								<form:input path="tenTaiKhoan" class="form-control"
									placeholder="Tên đăng nhập" type="text" name="tenDangNhap" />
							</div>
							<span><form:errors path="tenTaiKhoan" cssClass="error"
									style="color:red;"></form:errors></span>
						</div>
						<div class="form-group">
							<div class="input-group">
								<div class="input-group-addon">
								...
								<form:input path="matKhau" class="form-control"
									placeholder="******" type="password" name="tmatKhau" />

							</div>
							<span><form:errors path="matKhau" cssClass="error"
									style="color:red;"></form:errors></span>
					...
					<p class="text-center">
						Bạn có tài khoản không? <strong><a href="formdangki"
